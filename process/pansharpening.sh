...
if [ "$#" -ne 1 ]
then
  echo "Usage: $0 /root/landsat/zip LC81180442014356LGN00 4,3,2"
  exit 1
fi
...
otbcli_BundleToPerfectSensor -ram 1024 -inp ${DIR}/${BASE}_B8.TIF -inxs ${DIR}/rgb.vrt -out $TMP/pansharp.tif uint16
...
convert -monitor -sigmoidal-contrast 33x12% $TMP/pansharp_3857.tif $TMP/pansharp_3857-bright.tif
